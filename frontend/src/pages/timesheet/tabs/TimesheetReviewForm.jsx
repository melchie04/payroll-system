              ...
              actions={
                <div className="d-flex align-items-center gap-2">
                  {isDirty ? (
                    ...
                    savedAt && (
                      <span className="text-muted text-nowrap" style={{ fontSize: "var(--app-fs-1)" }}>
                        Saved {savedAt}
                      </span>
                    )
                  )}
                ...
                {rows.map((row) => {
                  ...
                  return (
                    <Tr key={row.day}>
                      <Td bold>
                        <div>{row.day}</div>
                        <div className="text-muted fw-normal" style={{ fontSize: "var(--app-fs-1)" }}>
                          {row.date}
                        </div>
                      </Td>
                      {[
          ...
          <div className="list-group list-group-flush">
            {REJECT_REASONS.map((reason) => (
              <label className="list-group-item d-flex align-items-center gap-2 px-3 py-2 mb-0" key={reason} style={{ cursor: "pointer" }}>
                ...
                />
                <span style={{ fontSize: "var(--app-fs-3)" }}>{reason}</span>
              </label>
            ))}
          </div>
        </div>
